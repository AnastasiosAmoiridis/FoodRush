namespace Common
{
    public static class EntityConstraints
    {
        ...
        public const byte MAX_EMAIL_LENGTH = 200; public const byte MAX_POSTALCODE_LENGTH = 10;

        public const short MAX_STREET_LENGTH = 300; public const short MAX_INSTRUCTION_LENGTH = 1000;

        public const decimal MAX_RATING_VALUE = 5.0m; public const decimal MIN_RATING_VALUE = 0.0m;

        public const string DEFAULT_SQL_KEY_VALUE = "NEWID()"; public const string CK_PRODUCT_BASEPRICE_MIN = "CK_Product_BasePrice_Min";
